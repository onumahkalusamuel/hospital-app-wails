...
<template>
  <div class="px-[15px] lg:flex justify-between border-t-[1px] border-gray-400">
    ...
    <div class="text-center flex items-center py-5 justify-center">
      <div class="hidden lg:inline-block">Per Page: &nbsp;</div>
      <div class="flex">
